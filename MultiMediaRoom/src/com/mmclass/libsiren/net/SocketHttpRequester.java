...
package com.mmclass.libsiren.net;
...
public class SocketHttpRequester {
    ...
    public static boolean post(String path, Map<String, String> params, FormFile[] files)
        ...
        for (FormFile uploadFile : files) {// 得到文件类型数据的总长度
            ...
            Log.d("upload", "path "+path+"file "+uploadFile.getFilname());
        }
        ...
        Socket socket = null;
         while(socket == null){
        	try{
        		...
        		Log.d("socket is null ", e.toString());
        	}
        }
    ...
    public static boolean postFiles(String path, Map<String, String> params, FormFile[] file)
            throws Exception {
        return post(path, params, file
        );
    }
    /**
     * 提交数据到服务器
     ...
     * @param encode 编码
     */
    public static byte[] postFromHttpClient(String path, Map<String, String> params, String encode)
            throws Exception {
